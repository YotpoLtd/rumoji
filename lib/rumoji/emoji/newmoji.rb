...
module Rumoji
  class Emoji
    NEWMOJI = SortedSet[
      ...
      self.new("\u{1FAF6}", [:hands_heart]),
      self.new("\u{1FAF6 1F3FB}", [:hands_heart_light_skin_tone]),
      self.new("\u{1FAF6 1F3FD}", [:hands_heart_medium_skin_tone]),
      self.new("\u{1FAF6 1F3FF}", [:hands_heart_dark_skin_tone]),
